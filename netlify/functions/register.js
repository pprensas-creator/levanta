      ...
      body: JSON.stringify({
        ...
        html: `<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto">
          ...
          <div style="background:#0d1f35;padding:16px;text-align:center;border-radius:0 0 12px 12px">
            <p style="color:rgba(255,255,255,.4);font-size:11px;margin:0">Para darte de baja, responde con el asunto "Baja".</p>
          </div>
        </div>`
      })
    });
      ...
      body: JSON.stringify({
        ...
        html: `<div style="font-family:Arial,sans-serif;padding:24px;max-width:500px">
          ...
          <table style="width:100%;border-collapse:collapse">
            ...
            <tr><td style="padding:8px;color:#6b7280;font-size:14px">Email</td><td style="padding:8px"><a href="mailto:${email}">${email}</a></td></tr>
